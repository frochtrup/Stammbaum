...
const _CLICK_MAP = {
  ...
  editPlaceName:           el  => editPlaceName(el.dataset.idx),
  ...
  qtSaveEntry:             ()  => qtSaveEntry(),
  qtEntryDone:             ()  => qtEntryDone(),
  ...
  menuExportStrict:        ()  => { closeModal('modalMenu'); exportGEDCOM(true, false, true); },
...
menuRevert:              ()  => { closeModal('modalMenu'); revertToSaved(); },
  ...
  menuPrintAhnenliste:    ()  => { closeModal('modalMenu'); _lazyScripts(['ui-book.js', 'ui-print.js']).then(() => downloadAhnenliste()).catch(() => showToast('⚠ Modul nicht ladbar', 'error')); },
  menuPrintFamilienbogen: ()  => { closeModal('modalMenu'); _lazyScripts(['ui-book.js', 'ui-print.js']).then(() => downloadFamilienbogen()).catch(() => showToast('⚠ Modul nicht ladbar', 'error')); },
  ...
  resetPlaceDataIDB:       ()  => resetPlaceDataIDB(),
  resetAllLocalData:       ()  => resetAllLocalData(),
  settingsChangePhoto:     ()  => { closeModal('modalSettings'); odImportPhotos(); },
  settingsChangeConfig:    ()  => odSetupConfigFolder(),
  odClearConfigFolder:     ()  => odClearConfigFolder(),
  odScanConfigFolder:      el  => odScanConfigFolder(el.dataset.odid, el.dataset.odname),
  ...
  toggleRlogTimeline:      ()  => toggleRlogTimeline(),
  ...
  showAddHypoForm:         el  => showAddHypoForm(el.dataset.pid),
  showAddFamHypoForm:      el  => showAddFamHypoForm(el.dataset.fid),
  saveAddHypo:             ()  => _saveAddHypo(),
  editHypo:                el  => _handleEditHypo(el),
  deleteHypo:              el  => _handleDeleteHypo(el),
  addHypoEvidence:         ()  => addHypoEvidenceRow(),
  removeHypoEvidence:      el  => removeHypoEvidence(el),
  toggleGpsNote:           el  => toggleGpsNote(el.dataset.pid),
  ...
  setDashFilter:           el  => _setDashFilter(el.dataset.filter),
  dashPromoteAll:          el  => _handleDashPromoteAll(el),
...
document.addEventListener('change', e => {
  ...
  else if (action === 'hofReviewAddVariant') hofReviewAddVariant(el);
