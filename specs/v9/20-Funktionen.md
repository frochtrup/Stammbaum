...
- **[K]** **Massen-Dedup** (ADR-v9-45, [11 §9.2](11-Orte-Hoefe-Identitaet.md)): eigene Ansicht (nicht identisch mit dem paarweisen Dubletten-Merge oben) — `findPlaceDuplicates` schlägt Gruppen mutmaßlich identischer Orte automatisch vor (Namens-Verträglichkeit, Koordinaten-Nähe, bare↔reich Cross-Achse), Gewinner-Vorschlag pro Gruppe, „Zusammenführen" als explizites Kommando. Kein automatisches Zusammenführen beim Laden.
