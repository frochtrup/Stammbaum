...
- **Quellen-Widget:** einheitlich in allen Formularen — Tags mit ✕, aufklappbarer Picker; im Ereignis-Formular zusätzlich Seitenfeld + QUAY-Dropdown + Evidenz-Aufklapper pro Quelle. **Kompakt** (INV-UI-5, Nachtrag 2026-07-06): Überschrift „Quellen" und „+ Quelle hinzufügen"-Button in einer Zeile; der Leerzustand-Text „Keine Quellen zugeordnet." entfällt ersatzlos (der Button allein zeigt bereits, dass noch keine Quelle zugeordnet ist — keine dritte Zeile für eine Nicht-Information).
