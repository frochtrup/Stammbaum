...
2. **Eine gemeinsame Bild-Primitive** trägt die vier Zustände sichtbar: Bild · Dokument (Symbol + „öffnen", kein `<img>`) · Weblink (↗ mit Host) · nicht auffindbar (⚠ mit Dateiname). „Nicht auffindbar" ist ein **Zustand**, kein leeres Kästchen — die Kachel bleibt lesbar, statt ein totes Bildsymbol zu zeigen.
