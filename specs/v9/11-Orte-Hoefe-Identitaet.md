...
> **INV-PLACE (Reprojektions-Invariante), Fassung seit ADR-v9-197:** `event.place` ist die **Wire-Wahrheit** — was in der Datei steht, bleibt dort stehen. Die periodengerechte Projektion `buildPlacForGedcom(event, year)` ist die **Anzeige**-Form; sie überschreibt die Quelle nur, wenn eine **ausdrückliche Nutzerhandlung** es verlangt. Weder Laden noch Speichern ist eine solche Handlung.
>
