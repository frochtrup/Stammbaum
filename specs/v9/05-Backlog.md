...
| BL-157 | S | feature | kür | Cross-Family (3/6, ADR-v9-127): `buildGedcomTreeFromModel(db)` — kompletter GEDCOM-Vollbaum von Grund auf (ermöglicht GRAMPS→GEDCOM, Zielformat = verbreitetstes); native GEDCOM-Suite bleibt grün | [13 §3](13-Interop-Roundtrip.md), [ADR-v9-127](04-Entscheidungslog.md#adr-v9-127) | `sym:buildGedcomTreeFromModel` | offen |
| BL-158 | S | feature | kür | Cross-Family (4/6, ADR-v9-127): `buildGrampsTreeFromModel(db)` — kompletter GRAMPS-Vollbaum (alle Sektionen) von Grund auf (ermöglicht GEDCOM→GRAMPS; löst ADR-v9-113 Befund 3 ab) | [13 §6](13-Interop-Roundtrip.md), [ADR-v9-127](04-Entscheidungslog.md#adr-v9-127) | `sym:buildGrampsTreeFromModel` | offen |
| BL-159 | S | test | kür | Cross-Family (5/6, ADR-v9-127): RT-4-Gate `A→Modell→B→Modell'` ⇒ `Modell≈Modell'` in beide Richtungen, an Klein- + Realdaten-Fixtures | [13 §1 RT-4](13-Interop-Roundtrip.md), [ADR-v9-127](04-Entscheidungslog.md#adr-v9-127) | `test:tests/roundtrip/cross-family.test.ts` | offen |
