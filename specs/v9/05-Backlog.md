...
| BL-151 | S | feature | kür | Geteilter Insel-Viewport (Fundament vor BL-122/123, ADR-v9-123): Drag-Pan, Pinch-Zoom (0.3–3×), Vollbild+Escape (BL-95), Auto-Fit, Reduced-Motion, Tastatur-Dispatch über generische `navTargets` — EINMAL statt je Insel (INV-UI-4). Sanduhr wird darauf umgestellt, ihre Tests bleiben grün (Regressionsschutz vor Feature). Insel liefert nur Layout-Modell + Zeichen-Callback; Kartenform inselspezifisch. Modus-Umschalter Sanduhr·Nachkommen·Fächer via `ViewModeToggle`, `route.treeMode` (analog `mapMode`) | [21 §8](21-UI-UX.md), [02 §5](02-Zielarchitektur-v9.md), [ADR-v9-123](04-Entscheidungslog.md#adr-v9-123) | `datei:ui/islands/tree/tree-viewport.ts` | offen |
