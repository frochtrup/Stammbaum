...
| Ⓞ Zeitachse der Orte | BL-324 (Tagesgenauigkeit) · BL-326 (die Sprachachse, unabhängig und noch unentschieden) | `core/places/types.ts`, `core/places/place-registry.ts`, `core/places/gov.ts`, `services/places/types.ts`, `ui/views/place/PlaceEnclosureEditModal.svelte`, `ui/views/place/PlaceNamesSection.svelte` |
...
4. **Welle 6 — die Zeitachse der Orte (2026-08-09, [ADR-v9-243](04-Entscheidungslog.md#adr-v9-243)):**
   BL-324 · BL-326. Der erste Schritt dieser Welle — der fehlende Überlappungs-Hinweis —
   ist am 2026-08-09 gebaut und steht deshalb nicht mehr hier; er war bewusst zuerst dran,
   weil ohne ihn gegen ein Problem gebaut würde, das niemand sehen kann.
   **BL-326 zuletzt und unabhängig:** es ist
