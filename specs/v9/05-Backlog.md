...
| BL-126 | S | feature | kür | Medien-Verwaltungs-**UI**: Kachelgalerie · Medium-Detail (globale vs. referenz-spezifische Felder) · Referenzliste mit `Picker`-Verknüpfen. **Kern-Vorbau gebaut** (ADR-v9-124): `Media`/`MediaCitation` + Interop-Migration + Roundtrip (`media.small.ged`, net_delta=0). Nur die UI fehlt noch | [20 §1.4/§1.5](20-Funktionen.md), [10 §4](10-Domaenenmodell.md) | `datei:ui/views/media/MediaGallery.svelte` | offen |
