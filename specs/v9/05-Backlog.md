...
| BL-122 | S | feature | kür | Nachkommen-Baum (top-down, Gen 2–7, Ehepartner/Geschwister, T-Linien): reine `descendant-layout.ts` (Orakel `legacy-v8` „Nachkommen-Ansicht"/`ui-desc-tree.js`) + Insel mountet in den geteilten Viewport (BL-151), teilt den Kartenrenderer der Sanduhr | [20 §1.3](20-Funktionen.md), [21 §8](21-UI-UX.md), [ADR-v9-123](04-Entscheidungslog.md#adr-v9-123) | `datei:ui/islands/tree/descendant-tree.ts` | offen |
