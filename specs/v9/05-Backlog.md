...
| ③ | Diagramm-Inseln | BL-151 (Viewport) → 122 → 123 → 152+121 (Heatmap) → 124 (Export) — Fundamente zuerst, s. [ADR-v9-123](04-Entscheidungslog.md#adr-v9-123) | `ui/islands/tree`, `core/validate` |
...
| BL-121 | S | feature | kür | Vollständigkeits-Heatmap: Ring am Rechteck-Kartenrand aus `computePersonSeverity` (BL-152, kein zweiter Mini-Validator) — die Insel bekommt die Schwere vorberechnet, wertet nichts aus; Mapping clean/info/warn/error → kein Ring/gold/orange/rot; im geteilten Kartenrenderer → Sanduhr UND Nachkommen. Fächer-Segment-Tönung = optionaler Nachzug | [20 §1.3](20-Funktionen.md), [21 §8](21-UI-UX.md), [ADR-v9-123](04-Entscheidungslog.md#adr-v9-123) | `txt:severity@ui/islands/tree/tree-viewport.ts` | offen |
| BL-123 | S | feature | kür | Fan-Chart (konzentrische Halbkreis-Segmente, 3–6 Generationen): reine polar `fan-layout.ts` (Ahnentafel-Traversal wie `computeKekuleNumbers`, Arc-Paths, Orakel v8 `ui-fanchart.js`) + Insel mountet in den Viewport (BL-151), Klick-Rezentrierung | [20 §1.3](20-Funktionen.md), [21 §8](21-UI-UX.md), [ADR-v9-123](04-Entscheidungslog.md#adr-v9-123) | `datei:ui/islands/tree/fan-chart.ts` | offen |
...
| BL-152 | S | feature | kür | Per-Person-Severity als geteilte Kern-Projektion (Fundament für BL-121, ADR-v9-123): `computePersonSeverity(db, config?): Map<PersonId, Severity>` — schwerster Befund je Person aus derselben Regel-Engine; `buildQualityDashboard` wird darauf umgestellt (ein Bewertungsmechanismus, zwei Anzeigeorte, kein zweiter Mini-Validator). DOM-frei, headless test-first, Dashboard-Parität als Test | [20 §1.3/§1.11](20-Funktionen.md), [21 §8](21-UI-UX.md), [ADR-v9-123](04-Entscheidungslog.md#adr-v9-123) | `sym:computePersonSeverity@core/validate/person-severity.ts` | offen |
