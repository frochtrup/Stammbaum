...
| BL-139 | S | feature | kür | GRAMPS-Export aus der UI erreichbar (Stufe 4, ADR-v9-114): `.gramps` importieren (gunzip-Adapter), `grampsDoc` im app-state halten, im nativen Format speichern/exportieren, Format im Dialog anbieten. Setzt BL-140/141/142 voraus (sonst hohl) — ein Menüpunkt allein wäre stiller Totalverlust | [13 §6](13-Interop-Roundtrip.md), [14 §3.2](14-Dateihandling.md), [ADR-v9-113](04-Entscheidungslog.md#adr-v9-113), [ADR-v9-114](04-Entscheidungslog.md#adr-v9-114) | `!txt:Exclude<ExportFormat@ui/shell/save-action.ts` | offen |
| BL-141 | S | feature | kür | GRAMPS-Orts-Auflösung (Stufe 2, ADR-v9-114 D3, String-Weg): die projizierten Event-Orts-Strings über `services/places.applyPlaceResolution` zu `placeId`/`hofId` binden — derselbe Dienst wie beim GEDCOM-Import, kein zweiter Pfad | [13 §6](13-Interop-Roundtrip.md), [11 §4](11-Orte-Hoefe-Identitaet.md), [ADR-v9-114](04-Entscheidungslog.md#adr-v9-114) | `test:tests/core/gramps-places.test.ts` | offen |
| BL-144 | S | feature | kür | GRAMPS Event/Zitat **Add/Remove** Write-Back (Folgestufe zu BL-142): das Hinzufügen/Entfernen GANZER geteilter Records mitziehen — Owner-`<eventref>`/`<citationref>`-Liste aktualisieren, neue `<event>`/`<citation>` synthetisieren (`grampsHandle`=null → deterministisches Handle), verwaiste entfernen. BL-142 deckt nur das Bearbeiten VORHANDENER Felder ab; Add/Remove berührt die Owner-Projektion, die dort bewusst bei Name/Geschlecht/Links blieb (D5-Plan) | [13 §6](13-Interop-Roundtrip.md), [ADR-v9-114](04-Entscheidungslog.md#adr-v9-114) | `test:tests/roundtrip/gramps-add-remove-events.test.ts` | offen |
