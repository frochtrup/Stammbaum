...
| Ⓝ Notizen (Anzeige & Erhalt) | BL-382 (Bearbeiten — Anzeige und Write-Back stehen) | `ui/views/person/PersonDetail.svelte`, `ui/views/family/FamilyDetail.svelte`, `ui/views/source/SourceDetail.svelte`, `core/interop/write-back.ts` |
...
3. **Welle 2 — eigenständige Kür:** BL-382 (Notizen bearbeiten — steht am Ende der Kette,
   die offene Frage darin ist das fehlende Familien-Formular) · BL-230 (die Ebenen-Wahl hängt sich in das gebaute
