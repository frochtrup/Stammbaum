...
|---|---|---|---|---|---|---|---|
| BL-96 | — | defekt | basis | INV-UI-11 hängt am Formfaktor, muss aber an der SPALTENBREITE hängen: der Desktop-Listen-Pane ist **352px** breit — schmaler als die 375px, für die das Budget gilt. Gemessen an `PlaceList`: 118px Toolbar (3 Umbruchzeilen) + 43px Segmentreihe = 161px von 765px Panenhöhe (21 %). [21 §3](21-UI-UX.md) sagt derzeit das Gegenteil — seine Begründung trägt nur für Navigation, nicht für Listen-Toolbars | [21 §6h](21-UI-UX.md), [21 §3](21-UI-UX.md) | `!txt:ist mobil skopiert@specs/v9/21-UI-UX.md` | offen |
