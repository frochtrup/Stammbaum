...
4. **Welle 6 — die Zeitachse der Orte (2026-08-09, [ADR-v9-243](04-Entscheidungslog.md#adr-v9-243)):**
   ...
   unter gültigen Namen, sondern die Frage, ob eine bewusste Nutzerhandlung die
   Verarmungs-Sperre im undatierten Fall überstimmen darf ([ADR-v9-292](04-Entscheidungslog.md#adr-v9-292)
   /[ADR-v9-295](04-Entscheidungslog.md#adr-v9-295)). Es blockiert nichts: der datierte
   Fall, also die große Mehrheit, funktioniert.
...
|---|---|---|---|---|---|---|---|
| BL-394 | S | defekt | kür | **Ein undatiertes Ereignis kann die Projektion nicht übernehmen** — `buildPlacForGedcom` liefert bei `when == null` `null`, sobald die Projektion eine Ebene fallenließe ([ADR-v9-292](04-Entscheidungslog.md#adr-v9-292)). Der Knopf „Projektion übernehmen" ([ADR-v9-295](04-Entscheidungslog.md#adr-v9-295)) und `linkEventToPlace` tun dort **sichtbar nichts**: ausgerechnet die eine Handlung, die als bewusster Übersteuerungs-Weg an der Verarmungs-Sperre vorbei gedacht ist, ist im undatierten Fall abgeschaltet. Die Sperre selbst bleibt richtig (ADR-v9-292 misst 2.022 erfundene Segmente an 696 Ereignissen) — falsch ist nur, dass sie eine EXPLIZITE Nutzerhandlung mitfängt, dieselbe Verwechslung wie in [ADR-v9-81](04-Entscheidungslog.md#adr-v9-81). **Fertig-Zustand:** ein Weg, auf dem der Nutzer die Kürzung im undatierten Fall bewusst annimmt (Vorschlag: die Zeile nennt die wegfallenden Ebenen, statt den Knopf verstummen zu lassen), plus ein Test, der den datierten Fall unverändert und den undatierten wirksam zeigt | [11 §5](11-Orte-Hoefe-Identitaet.md), [20 §1.4](20-Funktionen.md) | `test:tests/ui/undatierte-uebersteuerung.test.ts` | offen |
