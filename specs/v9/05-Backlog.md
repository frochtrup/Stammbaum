...
4. **Welle 6 — die Zeitachse der Orte (2026-08-09, [ADR-v9-243](04-Entscheidungslog.md#adr-v9-243)):**
   ...
   geschlossen.
5. **Welle 8 — die letzte Primitive ohne gewählte Schriftgröße (2026-08-11):** BL-347.
   Zuletzt, weil sie als einzige nicht lokal prüfbar ist: sie trifft jeden beschrifteten
   Knopf. **Herkunft:** die Messung zu [ADR-v9-257](04-Entscheidungslog.md#adr-v9-257) —
   beim Nachmessen der Glyphe fiel auf, dass `.stb-btn` dasselbe Versäumnis trägt.
...
| BL-347 | — | hygiene | kür | **`.stb-btn` steht ebenfalls auf dem User-Agent-Wert** — dieselbe Fehlerklasse wie BL-345: keine `font-size`, gemessen 13,333px; das Gewicht kommt aus `font-weight: 600` und Polsterung. Anders als die Glyphe trifft die Primitive JEDEN beschrifteten Knopf der App, eine Änderung ist also nicht lokal prüfbar. **Fertig-Zustand:** die Größe an mehreren Flächen gemessen (Formular-Knopfreihe, Gefahrenzone, Modal-Fuß), ein gewählter Wert gesetzt, und der Wächter aus BL-342 deckt sie mit ab | [21 §6](21-UI-UX.md), [ADR-v9-257](04-Entscheidungslog.md#adr-v9-257) | `txt:beschriftete Knopf-Primitive setzt ihre Schriftgroesse@tests/ui/sektions-ueberschrift.test.ts` | offen |
