...
**Welle 2a — die Zeitrechnung der Ortsaufloesung (aufgedeckt am 2026-08-26, [ADR-v9-286](04-Entscheidungslog.md#adr-v9-286)) ist am selben Tag vollstaendig abgetragen** und steht deshalb nicht mehr in der Liste: die Monats-Sprosse ([ADR-v9-287](04-Entscheidungslog.md#adr-v9-287)) und die undatierte Projektion ([ADR-v9-292](04-Entscheidungslog.md#adr-v9-292)). Die folgenden Wellen behalten ihre Bezeichnung, damit Verweise nicht ins Leere gehen.
...
4. **Welle 6 — die Zeitachse der Orte (2026-08-09, [ADR-v9-243](04-Entscheidungslog.md#adr-v9-243)):**
   BL-326 · BL-394. Vier Schritte dieser Welle — der fehlende Überlappungs-Hinweis, die
   ...
   geschlossen. **BL-394 hängt hier an, weil es dieselbe Naht betrifft** — nicht die Wahl
   unter gültigen Namen, sondern die Frage, was eine bewusste Übernahme der Projektion
   sichtbar verwirft ([ADR-v9-292](04-Entscheidungslog.md#adr-v9-292)/[ADR-v9-295](04-Entscheidungslog.md#adr-v9-295)).
   Es blockiert nichts und ist am Bestand mit **0 Kürzungen** gemessen — die Zeile steht
   für den konstruierbaren, nicht für den vorgefundenen Fall.
...
|---|---|---|---|---|---|---|---|
| BL-394 | S | feature | kür | **„Projektion übernehmen" nennt nicht, was es verwirft** — die Zeile aus [ADR-v9-295](04-Entscheidungslog.md#adr-v9-295) stellt Quelle und Feld nebeneinander; WELCHE Ebenen beim Übernehmen wegfallen, muss der Nutzer selbst durch Vergleichen herausfinden. `unbekannteEbenen(ev, ctx)` beantwortet genau diese Frage bereits — dieselbe Funktion, die den automatischen Angleich sperrt ([ADR-v9-224](04-Entscheidungslog.md#adr-v9-224)) und den Dashboard-Befund `PLAC_EBENE_UNBEKANNT` speist ([ADR-v9-247](04-Entscheidungslog.md#adr-v9-247)); die Zeile könnte sie schlicht nennen, statt eine dritte Fassung zu erfinden. **Der undatierte Fall ist der schärfste**, weil die Projektion dort nur der atomare Leitname ist ([ADR-v9-292](04-Entscheidungslog.md#adr-v9-292)) — potenziell fällt die ganze Kette, während der datierte Fall sie behält. **Am Realbestand gemessen** (`Testdateien/Unsere Familie 2026-4.ged` + `Testdateien/orte-5.json`, über den echten Ladepfad): 5208 gebundene Ortsereignisse, davon 680 undatiert, davon **16** mit sichtbarer Quelle-Zeile — und davon **0**, die der Knopf kürzt. Die 16 sind 15× Leerfeld-Bereinigung (`", Mainz, , , , "` → `"Mainz"`) und 1× die Reparatur aus [ADR-v9-294](04-Entscheidungslog.md#adr-v9-294). Deshalb **feature, nicht defekt**: es gibt keinen beobachteten Verlust, sondern eine Lücke in der Sichtbarkeit — der Fall ist konstruierbar (`Lehrte, Amt Burgdorf (Hannover)` → `Lehrte`), aber im Bestand nicht vorhanden. **Fertig-Zustand:** die Zeile benennt die wegfallenden Ebenen, wenn es welche gibt, und ein Test hält beides fest — die Benennung UND die Gegenprobe, dass bei reiner Leerfeld-Bereinigung nichts benannt wird (sonst trüge der häufigste Fall eine Warnung, die nichts meint) | [11 §5](11-Orte-Hoefe-Identitaet.md), [20 §1.4](20-Funktionen.md) | `test:tests/ui/quelle-zeile-ebenen.test.ts` | offen |
...
| ID | P | Typ | Klasse | Punkt | Spec | Beleg | Status |
|---|---|---|---|---|---|---|---|
| BL-402 | — | defekt | basis | **Die Ebenen-Regel meldete drei verschiedene Zustaende unter einer Beschriftung — nachgestellt am aktuellen Bestand, 12 Befunde, 0 davon echt** -> [ADR-v9-301](04-Entscheidungslog.md#adr-v9-301) | [11 §5](11-Orte-Hoefe-Identitaet.md), [20 §3](20-Funktionen.md) | `sym:ebenenBefund` | gebaut |
| BL-403 | — | defekt | basis | **Die Filteranzeige des Dashboards zaehlte die Abweichung von der Vorgabe statt der Einschraenkung — genau invertiert** -> [ADR-v9-301](04-Entscheidungslog.md#adr-v9-301) | [21 §10a](21-UI-UX.md) | `sym:UNGEFILTERTER_QUALITY_FOCUS` | gebaut |
| BL-404 | — | feature | basis | **Pruefregeln wirken sofort, ohne Speichern — wie der Filter-Dialog** -> [ADR-v9-301](04-Entscheidungslog.md#adr-v9-301) | [20 §3](20-Funktionen.md), [21 §10a](21-UI-UX.md) | `test:tests/ui/Validation.component.test.ts` | gebaut |
| BL-405 | — | feature | basis | **Vor dem stillen Überschreiben eine datierte Sicherung — plus „ohne Sicherung“ und „Speichern unter“** → [ADR-v9-302](04-Entscheidungslog.md#adr-v9-302) | [14 §4.1](14-Dateihandling.md) | `test:tests/services/backup-before-overwrite.test.ts` | gebaut |
| BL-406 | — | defekt | basis | **Ein blockiertes IndexedDB-Upgrade ließ die App still hängen (kein `onblocked`/`onversionchange`)** → [ADR-v9-302](04-Entscheidungslog.md#adr-v9-302) | [30 §2.2](30-NFR-und-Persistenz.md) | `test:tests/services/idb-schema-blocked.test.ts` | gebaut |
| BL-407 | — | defekt | basis | **Ohne verbundenen Backup-Ordner wurde trotzdem überschrieben — die selbst geschriebene Ausnahme höhlte INV-FILE-4 aus** → [ADR-v9-303](04-Entscheidungslog.md#adr-v9-303) | [14 §4.1](14-Dateihandling.md) | `test:tests/services/backup-before-overwrite.test.ts` | gebaut |
| BL-408 | — | defekt | basis | **Die angezeigte Ortskette wurde still anders gespeichert als angezeigt — 33 Fälle, 32 ohne Hinweis** → [ADR-v9-304](04-Entscheidungslog.md#adr-v9-304) | [11 §5](11-Orte-Hoefe-Identitaet.md), [20 §3](20-Funktionen.md) | `test:tests/core/anzeige-vs-datei.test.ts` | gebaut |
| BL-409 | — | defekt | basis | **Die Heiratszeile fehlte an Familien ohne `MARR` — und war nirgends anlegbar** → [ADR-v9-253](04-Entscheidungslog.md#adr-v9-253) Nachtrag | [20 §2](20-Funktionen.md), [ADR-v9-63](04-Entscheidungslog.md#adr-v9-63) | `test:tests/ui/immer-offen.test.ts` | gebaut |
| BL-410 | — | feature | basis | **Die Scheidung war lesbar, aber nicht anlegbar — und als einziger Ereignistag ohne deutsches Label** → [ADR-v9-305](04-Entscheidungslog.md#adr-v9-305) | [20 §2](20-Funktionen.md), [32 TST-29](32-Testframework.md) | `test:tests/core/event-tag-drift.test.ts` | gebaut |
| BL-411 | — | feature | basis | **Die Datensatz-Kennung war unsichtbar — und in der Familiensuche nicht auffindbar** → [ADR-v9-306](04-Entscheidungslog.md#adr-v9-306) | [20 §1.4/§1.5](20-Funktionen.md), [21 §6h](21-UI-UX.md) | `test:tests/ui/entity-id-visible.component.test.ts` | gebaut |
| BL-412 | — | feature | basis | **Weitere Namensformen (`extraNames`) reisten unsichtbar mit — jetzt les- und editierbar, samt Art des Hauptnamens** → [ADR-v9-306](04-Entscheidungslog.md#adr-v9-306) | [20 §1.4/§2](20-Funktionen.md), [10 §2](10-Domaenenmodell.md) | `test:tests/roundtrip/namensform-edit.test.ts` | gebaut |
| BL-401 | — | defekt | basis | **Die Ebenen-Pruefung teilte den Ortstext naiv am Komma — Hofnamen mit Komma in Klammern zerfielen in erfundene Verwaltungsebenen** -> [ADR-v9-300](04-Entscheidungslog.md#adr-v9-300) | [11 §5](11-Orte-Hoefe-Identitaet.md), [20 §3](20-Funktionen.md) | `test:tests/core/undatierte-projektion.test.ts` | gebaut |
| BL-400 | — | defekt | basis | **Die Ereigniszeile im Personen-Steckbrief loeste die Ortskette jahresweise auf, die Projektion tagegenau** -> [ADR-v9-299](04-Entscheidungslog.md#adr-v9-299) | [11 §5](11-Orte-Hoefe-Identitaet.md), [21 §6f](21-UI-UX.md) | `test:tests/ui/person-display.test.ts` | gebaut |
| BL-399 | — | hygiene | basis | **Der Leerzustands-Satz schickte zum Datei-Oeffnen, obwohl der Nutzer leer begonnen hatte** -> [ADR-v9-297](04-Entscheidungslog.md#adr-v9-297) | [20 §1.1](20-Funktionen.md) | `sym:emptyEntityHint` | gebaut |
| BL-397 | — | feature | basis | **Startbildschirm beim Erststart** — bis dahin ein Satz in einer leeren Liste, der Rundgang laeuft erst nach dem Demo-Laden und nur mobil → [ADR-v9-297](04-Entscheidungslog.md#adr-v9-297) | [20 §1.1](20-Funktionen.md) | `test:tests/ui/StartScreen.component.test.ts` | gebaut |
| BL-398 | — | feature | basis | **Reset des lokalen Speichers** — in [14 §3.3](14-Dateihandling.md) spezifiziert, nirgends gebaut; Umfang jetzt über `ALL_STORES` statt Prosa → [ADR-v9-297](04-Entscheidungslog.md#adr-v9-297) | [14 §3.3](14-Dateihandling.md) | `test:tests/services/reset-local-state.test.ts` | gebaut |
| BL-396 | — | defekt | kür | **Der automatische Hof-Nachlauf nutzte eine zweite, aeltere Gewinner-Heuristik** -> [ADR-v9-298](04-Entscheidungslog.md#adr-v9-298) | [11 §9.2](11-Orte-Hoefe-Identitaet.md) | `test:tests/core/hof-nachlauf-gewinner.test.ts` | gebaut |
| BL-395 | — | feature | basis | **Der Dedup-Vorschlag entschied eine Ebene über dem Dorf per ID-String** → [ADR-v9-296](04-Entscheidungslog.md#adr-v9-296) | [11 §9.2](11-Orte-Hoefe-Identitaet.md), [20 §1.7](20-Funktionen.md) | `test:tests/ui/curation-dedup.test.ts` | gebaut |
| BL-392 | — | defekt | basis | **Ein Ereignis-Edit loeschte das Hof-Leitsegment aus `PLAC` — im Ortsfeld stand ein Anzeige-Label statt der Projektion** → [ADR-v9-295](04-Entscheidungslog.md#adr-v9-295) | [11 §3](11-Orte-Hoefe-Identitaet.md), [20 §1.4](20-Funktionen.md) | `test:tests/ui/event-edit.test.ts` | gebaut |
| BL-393 | — | feature | basis | **Quelle neben Projektion im Ereignis-Modal — sichtbar machen, was ein Edit verwirft** → [ADR-v9-295](04-Entscheidungslog.md#adr-v9-295) | [20 §1.4](20-Funktionen.md), [21 §7](21-UI-UX.md) | `test:tests/ui/EventEditModal.component.test.ts` | gebaut |
| BL-390 | — | defekt | basis | **Hoefe entstanden still in einem Landkreis — der Bootstrap fragte nie, welche Verwaltungsebene der Anker ist** → [ADR-v9-293](04-Entscheidungslog.md#adr-v9-293) | [11 §4.2](11-Orte-Hoefe-Identitaet.md), [11 §4.3](11-Orte-Hoefe-Identitaet.md) | `test:tests/core/konvention-matrix.test.ts` | gebaut |
| BL-391 | — | defekt | basis | **Ein Komma in einer Klammer zerschnitt Hofnamen und Ortskette — die Regel lag an drei Stellen** → [ADR-v9-294](04-Entscheidungslog.md#adr-v9-294) | [11 §4.2](11-Orte-Hoefe-Identitaet.md), [11 §4.4](11-Orte-Hoefe-Identitaet.md) | `test:tests/core/places-normalize.test.ts` | gebaut |
| BL-379 | — | test | basis | **Der Mutations-Ansatz wird zur Naht; M3 (Nutzer-Edit) als zweite Mutation** → [ADR-v9-282](04-Entscheidungslog.md#adr-v9-282) | [32 TST-31](32-Testframework.md) | `test:tests/roundtrip/wire-edit-ankunft.test.ts` | gebaut |
| BL-380 | — | defekt | basis | **Ein Edit an einem `0 @N@ NOTE`-Record wurde still verschluckt** → [ADR-v9-284](04-Entscheidungslog.md#adr-v9-284) | [13 §2](13-Interop-Roundtrip.md), [32 TST-31](32-Testframework.md) | `test:tests/roundtrip/note-record-write-back.test.ts` | gebaut |
| BL-389 | — | defekt | basis | **Eine zweite Notiz anzulegen loeschte die Quellenzitation der ersten** → [ADR-v9-291](04-Entscheidungslog.md#adr-v9-291) | [13 §2](13-Interop-Roundtrip.md) | `test:tests/roundtrip/note-zitat-passthrough.test.ts` | gebaut |
| BL-388 | — | defekt | basis | **Ein Notiz-Zeiger vor einer Inline-Notiz zerstoerte die Notiz beim Neubau** → [ADR-v9-290](04-Entscheidungslog.md#adr-v9-290) | [13 §2](13-Interop-Roundtrip.md) | `test:tests/roundtrip/note-zeiger-reihenfolge.test.ts` | gebaut |
| BL-387 | — | test | basis | **Der Struktur-Korpus der Mutations-Naht kannte weder Fortsetzungen noch wiederholte Geschwister** → [ADR-v9-289](04-Entscheidungslog.md#adr-v9-289) | [32](32-Testframework.md) | `txt:DIE DRITTE ACHSE@tests/roundtrip/wire-mutation-harness.ts` | gebaut |
| BL-386 | — | defekt | basis | **Ein zweites `_RATIO` war unsichtbar und vermehrte sich bei jeder Bearbeitung** → [ADR-v9-288](04-Entscheidungslog.md#adr-v9-288) | [12 §4](12-Forschungsdaten.md), [13 §2.3](13-Interop-Roundtrip.md) | `test:tests/core/interop-hypothesis.test.ts` | gebaut |
| BL-384 | M | defekt | kür | **Ein undatiertes Ereignis verlor bei der Reprojektion die ganze Verwaltungskette** → [ADR-v9-292](04-Entscheidungslog.md#adr-v9-292) | [11 §5](11-Orte-Hoefe-Identitaet.md), [13 §2](13-Interop-Roundtrip.md) | `test:tests/core/undatierte-projektion.test.ts` | gebaut |
| BL-385 | S | defekt | kür | **Ein monatsgenaues Datum wurde auf das ganze Jahr verbreitert** — `spanneVonEreignis` kannte nur zwei Sprossen, `MAY 1808` war identisch zu `NOV 1808` → [ADR-v9-287](04-Entscheidungslog.md#adr-v9-287) | [11 §1](11-Orte-Hoefe-Identitaet.md) | `test:tests/core/zeitbezug.test.ts` | gebaut |
| BL-383 | — | defekt | basis | **Hofadressen wurden als Ortsebene geseedet — die Hof-Erkennung schloss vom Text statt vom Objekt** → [ADR-v9-286](04-Entscheidungslog.md#adr-v9-286) | [11 §4.2](11-Orte-Hoefe-Identitaet.md), [30 §3](30-Qualitaet-und-Betrieb.md) | `test:tests/core/place-seed-matrix.test.ts` | gebaut |
| BL-382 | — | feature | basis | **Notizen bearbeiten — geteilte Records, `extraNotes` und die Familien-Notiz hatten keine Fläche** → [ADR-v9-285](04-Entscheidungslog.md#adr-v9-285) | [20 §2](20-Funktionen.md), [21 §7](21-UI-UX.md) | `test:tests/ui/NotesSection.component.test.ts` | gebaut |
| BL-381 | — | defekt | basis | **Notiz-Sektion je Steckbrief — 53 % des Notiztextes war auf keiner Lesefläche zu sehen** → [ADR-v9-283](04-Entscheidungslog.md#adr-v9-283) | [20 §1.4](20-Funktionen.md), [21 §10](21-UI-UX.md) | `test:tests/ui/NotesSection.component.test.ts` | gebaut |
