...
| Ⓤ UI-Hygiene | BL-343 (Abschnitts-Abstand als gap statt kopiertem margin) | Detail-Ansichten |
...
4. **Welle 6 — die Zeitachse der Orte (2026-08-09, [ADR-v9-243](04-Entscheidungslog.md#adr-v9-243)):**
   ...
   geschlossen.
5. **Welle 8 — UI-Hygiene aus dem Überschriften-Audit (2026-08-11):** BL-343. Bewusst
   NACH allem Fachlichen: es ändert kein Verhalten, nur die Form, in der ein Abstand
   deklariert ist. **Herkunft:** der Audit zu [ADR-v9-255](04-Entscheidungslog.md#adr-v9-255)
   — die Vereinheitlichung der Überschrift deckte dieselbe Kopier-Klasse eine Ebene höher auf.
...
| BL-343 | — | hygiene | kür | **Der Abschnitts-Abstand steht in sieben Ansichten noch als kopiertes `margin`** — `1.25rem` achtfach dekliniert, davon fünfmal `margin-top` und zweimal `margin-bottom` (also nicht einmal einheitlich). Der Personen-Steckbrief trägt ihn seit [ADR-v9-255](04-Entscheidungslog.md#adr-v9-255) als `gap` am Container — die robustere Form, die eine Komponenten-Extraktion nicht verlieren kann. **Fertig-Zustand:** die übrigen sieben Detail-Ansichten ebenso, und der Wächter aus BL-342 zählt zusätzlich die verbliebenen `__section`-Margins gegen eine Ratsche | [21 §6](21-UI-UX.md), [ADR-v9-255](04-Entscheidungslog.md#adr-v9-255) | `txt:abschnittsAbstandRatsche@tests/ui/sektions-ueberschrift.test.ts` | offen |
