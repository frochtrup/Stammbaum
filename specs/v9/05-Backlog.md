...
| BL-155 | S | feature | kür | Cross-Family (1/6, ADR-v9-127): Coverage-Audit (was passthrough-only ist, je Entität, an Realdaten gemessen) + reiner Äquivalenz-Vergleicher `modelEquiv(a,b)` für RT-4 (`modelEquiv(db,db)===[]`) | [13 §1 RT-4](13-Interop-Roundtrip.md), [ADR-v9-127](04-Entscheidungslog.md#adr-v9-127) | `sym:modelEquiv` | offen |
