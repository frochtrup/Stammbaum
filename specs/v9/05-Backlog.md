...
| BL-156 | S | feature | kür | Cross-Family (2/6, ADR-v9-127): ID-Remap `Modell-id→Ziel-id` + Referenz-Rewriting (Verallgemeinerung `assignNewIds`) + Enum-/Wert-Normalisierung beidseitig (Ereignistyp/`MEDI`/`PEDI`/`QUAY`↔`confidence`) | [ADR-v9-127](04-Entscheidungslog.md#adr-v9-127), [ADR-v9-11](04-Entscheidungslog.md#adr-v9-11) | `sym:remapIdsForFormat` | offen |
