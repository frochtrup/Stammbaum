...
| Ⓙ Bearbeitung & Formulare | BL-233 · BL-354 (der JSON-Transport einzelner Erfassungs-Vorlagen; Kern, Erfassungs-Fläche und das Arbeits-Ziel samt Builder sind gebaut) · BL-334 (Meldungs-Kanäle) | `ui/shell/StatusNotice.svelte`, `ui/views/person`, `ui/views/place`, `ui/views/hof`, `ui/views/media`, `ui/shell` (Formulare, `SourceCitationRow`, Ablage, `EventEditModal`), `core/model/entry-templates.ts`, `services/app-data/`, `tests/ui/touch-target.test.ts` |
...
5. **Welle 3 — Infra & Hygiene (opportunistisch):**
   ...
   **BL-354** (der letzte offene Schritt der Erfassungs-Vorlagen,
   [ADR-v9-264](04-Entscheidungslog.md#adr-v9-264) — Kern, Erfassungs-Fläche und das
   Arbeits-Ziel samt Builder sind gebaut) · BL-322 (die beiden
