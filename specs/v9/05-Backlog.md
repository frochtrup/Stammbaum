...
| BL-142 | S | feature | kür | GRAMPS Write-Back Modell→Baum (Stufe 3, ADR-v9-114 D5): `gramps-write-back` um Events/Daten/Zitate erweitern — projizierte Felder zurückschreiben, unveränderte Records byte-treu (identischer Knoten, INV-PT), Roundtrip `xml1===xml2`. Erst hiernach round-trippt Bearbeitung | [13 §6](13-Interop-Roundtrip.md), [ADR-v9-114](04-Entscheidungslog.md#adr-v9-114) | `test:tests/roundtrip/gramps-write-back-events.test.ts` | offen |
