...
4. **Welle 6 — die Zeitachse der Orte (2026-08-09, [ADR-v9-243](04-Entscheidungslog.md#adr-v9-243)):**
   ...
   geschlossen.
5. **Welle 8 — die offene Design-Frage aus dem Knopf-Audit (2026-08-11):** BL-348.
   Zuletzt, weil es keine Aufräumarbeit ist: ob der vierte Look eine Variante wird oder
   auf `secondary` zurückfällt, ist zu entscheiden, nicht zu erledigen. **Herkunft:** der
   Wächter-Bau zu [ADR-v9-258](04-Entscheidungslog.md#adr-v9-258).
6. **Welle 3 — Infra & Hygiene (opportunistisch):**
...
| BL-348 | — | hygiene | kür | **Ein vierter Knopf-Look lebt in vier Komponenten lokal** — `PersonMergeModal`, `PlaceMergeSection`, `EventAgeHelper` u. a. führen einen gefüllten `surface-3`-Knopf mit `gold-dim`-Rahmen. Kein Nachbau einer vorhandenen Variante (die Primitive bietet primary/secondary/danger), sondern eine Optik, die es dort nicht gibt — beim Wächter-Bau zu [ADR-v9-258](04-Entscheidungslog.md#adr-v9-258) gemessen und bewusst ausgeklammert: ob dieser Look eine Variante werden soll oder auf eine vorhandene zusammenfällt, ist eine Design-Entscheidung, keine Aufräumarbeit. **Fertig-Zustand:** entschieden und entweder als Variante in der Primitive oder auf `secondary` zurückgeführt; der Wächter erfasst danach auch diese Signatur | [21 §6](21-UI-UX.md), [ADR-v9-258](04-Entscheidungslog.md#adr-v9-258) | `txt:surface-3-Knopf@ui/shell/design-system.css` | offen |
