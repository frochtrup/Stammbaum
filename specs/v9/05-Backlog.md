...
| BL-143 | S | feature | kür | Volle GRAMPS-Ortshierarchie ins Modell (Stufe 5, ADR-v9-114 D3 — als Pflicht markiert, nicht Passthrough): `<placeobj type>` + `<placeref>`-Kette + `<coord>` auf `PlaceObject`/`Hof` und die v9-Konventionsmatrix abbilden, damit GRAMPS-Orte (fundamentales GRAMPS-Konzept) editierbar sind statt nur als String durchzulaufen | [13 §6](13-Interop-Roundtrip.md), [11 §4](11-Orte-Hoefe-Identitaet.md), [ADR-v9-114](04-Entscheidungslog.md#adr-v9-114) | `test:tests/core/gramps-place-hierarchy.test.ts` | offen |
