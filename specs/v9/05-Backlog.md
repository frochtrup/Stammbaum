...
| BL-84 | — | hygiene | kür | 26 tote Anker-Links (21 davon `#adr-v9-NN`-Kurzverweise aus [04a](04a-Chronik.md) — die ADR-Überschriften tragen Titel/✅/Datum, GitHub-Slugs brauchen den vollen Text; 4× `#18-höfe-tab`/`#17-orte-tab` in [20](20-Funktionen.md), deren Überschriften einen nachgestellten `*(Kern: …)*`-Link tragen, der mit in den Anker wandert; 1× in [21 §3](21-UI-UX.md)); auch [CLAUDE.md](../../CLAUDE.md) betroffen. Zählung 2026-07-19 gegen den echten `github-slugger` verifiziert (nicht gegen eine selbstgebaute Slug-Regel — die lieferte zuvor Falschmeldungen in beide Richtungen) | [04](04-Entscheidungslog.md), [04a](04a-Chronik.md) | `txt:check-anchors@.claude/skills/spec-lint/SKILL.md` | offen |
...
| BL-106 | S | feature | basis | Import-Vergleich: `applyImportPatch` als Kern-Kommando — Feld übernehmen · A+B (Import-Wert als Notiz) · neue Person komplett importieren mit Rekonstruktion der Familienbindungen · automatisch angelegte Import-Quelle als Beleg | [20 §1.12](20-Funktionen.md), [10 §4](10-Domaenenmodell.md) | `sym:applyImportPatch` | offen |
| BL-107 | S | feature | basis | Import-Vergleich: Ansicht — zweite Datei wählen, Klassifikations-Liste, Diff in drei Kategorien (Identisch ausblendbar), je Feld Übernehmen · Forschungseintrag · Ignorieren, „≠ Andere Person" | [20 §1.12](20-Funktionen.md), [21 §10b](21-UI-UX.md) | `datei:ui/views/import/ImportCompareView.svelte` | offen |
