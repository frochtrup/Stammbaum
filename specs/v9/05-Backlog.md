...
| Ⓝ Notizen (Anzeige & Erhalt) | BL-381 (die Sektion — der sichtbare Teil) · BL-380 (Write-Back, muss vor jeder Bearbeitung stehen) | `ui/views/person/PersonDetail.svelte`, `ui/views/family/FamilyDetail.svelte`, `ui/views/source/SourceDetail.svelte`, `core/interop/write-back.ts` |
...
3. **Welle 2 — eigenständige Kür:** BL-381 (die Notiz-Sektion; sie ist der Grund, aus dem BL-380
