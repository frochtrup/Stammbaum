...
| Ⓗ Import / Export / Dedup | BL-317 (Anzeige + Prüfung strukturierter Adressen) · BL-315 (offener Defekt, wartet auf die eigene Diagnose) · BL-207 · BL-313 (Randfall der Autoritätsregel, unabhängig) · BL-166 (vertagt) | Write-Back, Import-Vergleich, Dedup, Export-Pipe |
...
1. **Welle 5 — was ein Nutzer heute trifft:** BL-317 · BL-315. BL-317 zuerst, weil es die einzige der beiden ist, die sich bauen lässt: Steht vorn, weil es die einzige
