...
| Ⓝ Notizen (Anzeige & Erhalt) | BL-380 (Write-Back, muss vor jeder Bearbeitung stehen) · BL-382 (Bearbeiten; setzt ihn voraus) | `ui/views/person/PersonDetail.svelte`, `ui/views/family/FamilyDetail.svelte`, `ui/views/source/SourceDetail.svelte`, `core/interop/write-back.ts` |
...
3. **Welle 2 — eigenständige Kür:** BL-382 (Notizen bearbeiten — steht am Ende der Kette,
   die offene Frage darin ist das fehlende Familien-Formular) · BL-380 (Notiz-Records kennt der GEDCOM-Write-Back nicht —
