...
**sw-Version:** v630 · Cache: `stammbaum-v630`
...
| EXPORT-UNSTACK | **PNG-Export: Stapel auflösen** | Sanduhr-Export: Geschwister- und Ehepartner-Stapel (Peek-Karten) im Export vollständig nebeneinander ausfalten statt überlagert; `_buildTreeSvg()` berechnet neue Positionen aus den DOM-Karten; Geschwister horizontal links, Ehepartner horizontal rechts; SVG-Breite wächst entsprechend. | S |
