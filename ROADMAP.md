...
**Handbuch-Stand: sw v994 *(aktuell)*** — beide Versionsfelder im HANDBUCH (Header + Footer) auf v994. Neu (Kap. 15): eigene geräteübergreifende Hof-Koordinaten + Binnenwanderung auf der Karte (ADR-026), 🏡-Hof-Picker bei der Wohnort-Eingabe + Ort/Hof-Trennung. *Bewusst ohne Handbuch-Eintrag (rein intern):* Farm-placeObject-Migration, hofObjects-Sidecar/Dual-write, Enclosure-Ketten, Reprojektion — die korrekte Anzeige ist für Nutzer transparent. Zuvor: Hof-Notiz vs. Wohnort-Notiz-Trennung mit `[Hof]`-Marker (Kap. 15). Neu dokumentiert: Boot-Loader/Start-Anzeige (Kap. 2), verwaiste Quellbezüge (⚠-Badge + ✕-Entfernen, Kap. 6) + Validator-Regel „Quellbezug ohne vorhandene Quelle" (Kap. 13, jetzt 31 Regeln), Quellen-Auswahl bei Aufgaben (Kap. 13), Orts-Dubletten-Badge auf ⇉ (Kap. 7). Bereits zuvor dokumentiert: 12 Druckausgaben (Kap. 20), Ort-Steckbrief inkl. Verwaltungs-Zeitlinie WYSIWYG (Kap. 7), Template-Generator (Kap. 4), periodengerechte Ortsanzeige mit 🏘-Sprung (Kap. 4), RESI-Datums-Schnellhilfe + Hof-Notiz-Automatik (Kap. 15), Skalierung/Barrierefreiheit in FAQ. *Bewusst ohne Handbuch-Eintrag (rein interne Änderungen):* View-Robustheit-Internals P0–P6, Koord-Single-Source, Orts-Projektions-Invariante (v983–v985, intern — die korrekte historische Ortsanzeige ist für Nutzer transparent), T0-UI-Tests, CSP-Durchsetzung + Pre-Commit-Gate, T0-FUNC-SPLIT, Vorname-Normalisierung. *(Offen: echte Screenshots statt Mockups → DOC-SCREENS.)*
