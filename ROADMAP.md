...
**sw-Version:** v466 · Cache: `stammbaum-v466`
...
| ~~Nachkommen~~ | ~~**Nachkommen-Baum**~~ | ✅ **Abgeschlossen** (sw v466): `ui-desc-tree.js`; Toggle-Button `⇩` im Baum-View; Gen-Buttons 2–7; T-Linien-Layout; `▼`-Badge bei abgeschnittener Tiefe; Ehepartner-Karte rechts + ⚭-Button; Geschwister-Stapel links (PEEK-Überlapp) | ~~L~~ |
