...
**sw-Version:** v781 · Cache: `stammbaum-v781`
...
**Handbuch-Stand: sw v769** *(veraltet — v770–v780 [QUICK-TPL age-Feldtyp, Qualitäts-Dashboard RES-DASH, Evidenzmodell RES-EVAL 2a–2e, RES-PROJ 3a–3c (Kanban + Projekte + Timeline)] noch nicht dokumentiert. v750–v758 [Test-Automation, GRAMPS-/Parser-Fixes, ESM-Migration, PAGE-URL-Migration] sind Infrastruktur ohne nutzersichtbare Bedienung und bewusst nicht im Endnutzer-Handbuch.)*
