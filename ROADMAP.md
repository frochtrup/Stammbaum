...
**sw-Version:** v915 · Cache: `stammbaum-v915` · `test-unit.js` = 420 Tests grün · GEDCOM Roundtrip `net_delta=0` stabil · GRAMPS stabil
...
| Funktionsstand | **9.0/10** | Undo/Redo · Karten-Animation · Evidenzmodell · GPS-Hypothesen · GED7 · GRAMPS · ASSO-Edit · Verwandtschaftsrechner · Nominatim-Geocoding · GOV-Import (historisch datiert) · Ort-Steckbrief + Ortsbuch-Export (v892) + Validator · Multi-Device-Konflikterkennung. **OUTPUT-RICHNESS Tier A+B (v911–v915):** Quellenverzeichnis, Forschungsprotokoll-Export, Statistik-Report, Nachkommentafel (d'Aboville), Familienbuch-Buchreife (Cover/Glossar/@page), Großposter-SVG (A1/A0-Vektor), Verwandtschaftsnachweis. **Abzug:** Tier C (Wall-Chart/Ortssippenbuch/Zeitstrahl-Druck) offen; DNA/Online-Matching bewusst out-of-scope. |
...
| Dokumentation | 8.5/10 | **25 ADRs** mit „Alternativen erwogen/verworfen" + Datamodel + ~2.2k-Z.-Changelog. **Abzug:** Bewertungstabelle lief dem Code hinterher (Phantom-`_attr`, Testzahl, Skalierung — jetzt korrigiert → DOC-SYNC); Handbuch v915 für Ausgaben/Diagramme aktualisiert, aber Backend-/UX-Features v859–v909 noch undokumentiert (→ DOC-SCREENS); Screenshots teils Mockups. |
...
| **∅ Gesamt** | **≈ 8.6/10** | *Außergewöhnlich diszipliniertes Solo-Projekt; Kernversprechen (verlustfreie GEDCOM/GRAMPS-Treue, strenge Sicherheit, lokal-first, plattformübergreifend) empirisch bestätigt. T0-FUNC-SPLIT (v904) + CSP-DURCHSETZUNG (v903) beseitigen die stärksten Code-Qualitäts-Abzüge. A11Y-AUDIT (v905) belegt WCAG 2.1 AA. OUTPUT-RICHNESS Tier A+B (v911–v915) schließt den größten fachlichen Abstand zu MFT (Quellenverzeichnis, Statistik-/Forschungs-Reports, Nachkommentafel, Familienbuch-Buchreife, Großposter-SVG, Verwandtschaftsnachweis). Größte verbleibende Hebel: (1) OUTPUT-RICHNESS Tier C (Wall-Chart/Ortssippenbuch/Zeitstrahl); (2) Backend-/UX-Features v859–v909 ins Handbuch → DOC-SCREENS.* |
...
| **3** | ✅ **OUTPUT-RICHNESS Tier A+B** — Reports/Buch/Poster-Export | Größter fachlicher Abstand zu MacFamilyTree. Tier A (Quellenverzeichnis, Forschungsprotokoll, Statistik) + Tier B (Nachkommentafel, Familienbuch-Buchreife, Großposter-SVG, Verwandtschaftsnachweis) erledigt v911–v915. Tier C offen. | L | ✅ v911–v915, s. P4 |
...
| 5 | **DOC-SCREENS / Handbuch v859–v909** — echte Screenshots + Restfeatures | Ausgaben/Diagramme auf v915 dokumentiert (Versionsfelder gesetzt); Backend-/UX-Features v859–v909 + echte Screenshots offen. | M | s. Dokumentation |
...
| **C1** | **Stammtafel Wall Chart** *(Ancestris, Ahnenblatt, MacFamilyTree)* | Vorfahren + Nachkommen kombiniert in einem Baumplan (horizontal oder vertikal), druckbar als mehrseitiges A4-HTML mit Seitennummern oder als SVG-Vektor für A1. Fächer-Diagramm als Vektor-Variante möglich. | **L** |
| **C2** | **Ortssippenbuch + Narrative** *(Ahnenblatt, Gramps Place-based Reports)* | Alle Familien die in einem Ort lebten, gruppiert nach Ort, mit Story-Kurztext pro Familie. Ausbau `exportOrtsbuch` (v892) in `ui-print.js`. Kombination von Ortsregister + Familien-Narrativen. | **L** |
| **C3** | **Periodisierter Zeitstrahl-Ausdruck** *(MacFamilyTree „Zeitleiste drucken", Gramps Timeline Chart)* | Person + Familie: alle Ereignisse auf horizontaler Zeitachse, überlagert mit historischen Epochen aus `story-epochs.js`. Druckbar als Querformat A4 oder A3. Basis: `ui-timeline.js`. | **L** |
...
**Handbuch-Stand: sw v915** — Versionsfelder auf v915 gesetzt. **Kapitel „Druckausgaben" (Kap. 20) + „Diagramme" (Kap. 8) vollständig auf OUTPUT-RICHNESS aktualisiert** (A2 Quellenverzeichnis, A3 Forschungsprotokoll-Export, A4 Statistik-Report, B1 Nachkommentafel, B2 Familienbuch-Buchreife mit Cover/Glossar, B3 Großposter-SVG, B4 Verwandtschaftsnachweis, alle v911–v915). *Noch offen (Backend-/UX-Features ohne Handbuch-Eintrag, v859–v909):* View-Robustheit P0–P6, Koord-Paar-Invariante/-Löschen, po-gewinnt-immer, Ereignisliste/-gruppen, VS-Scroll-Reattach, UI-Logik-Tests T0-UI, Ortsreport/Ortsbuch v892, SCALE/SORT-CACHE v899, Orts-Notiz v900, CSP-Durchsetzung v901–v903, T0-FUNC-SPLIT v904, A11Y-AUDIT v905, Lücken-Ketten v908, Vorname-Normalisierung v909.
...
| Reports / Bücher / Poster | ✅ gut (Familienbuch m. Cover/Glossar, Ahnenliste, Nachkommentafel d'Aboville, Quellenverzeichnis, Statistik-/Forschungs-Report, Verwandtschaftsnachweis, Großposter-SVG A1/A0 — v911–v915) | **✅ exzellent (PDF-Bücher, Großposter)** | ✅ sehr gut | ⚠ mittel |
...
- vs. **MacFamilyTree** *(der direkte Maßstab)*: ① restlicher Ausgabe-Reichtum (3D-Tree, kombinierte Wall-Charts → OUTPUT-RICHNESS Tier C; Tier A+B v911–v915 erledigt) · ② nahtloser Multi-Device-Sync (CloudKit — Stammbaum hat Konflikterkennung, aber manuellen Sync) · ③ Reife/Politur. **Dafür schlägt Stammbaum MFT bei:** GEDCOM-Treue, Forschungsprozess-Rigorosität (GPS/Hypothesen/Kanban), historisches Orts-Handling (datierte GOV-Ketten), Plattform-Reichweite, Privacy, Preis.
